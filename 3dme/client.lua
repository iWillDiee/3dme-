local color = { r = 233, g = 67, b = 67, alpha = 255 } -- Color of the text 
...
RegisterCommand('me', function(source, args)
    ...
    text = text .. ' '
    TriggerServerEvent('3dme:show', text)
end)

RegisterNetEvent('3dme:showDisplay')
AddEventHandler('3dme:showDisplay', function(text, source)
